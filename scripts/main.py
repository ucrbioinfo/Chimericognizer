...
#    num_iterations = 5
    ...
    paras_string = "f:i:o:m:t:p:n:x:y:a:b:c:d:e:h:r:q:"
    ...
    chimeric_removal(paras_file, fasta_list_file, output_dir, REFALIGNER,  optmap_list_file, num_threads, threshold_1, threshold_2, threshold_3, threshold_4, threshold_5, threshold_6)        
