...
def chimeric_removal(paras_file, fasta_list_file, output_dir, REFALIGNER, optmap_list_file, num_threads, threshold_1, threshold_2, threshold_3, threshold_4, threshold_5, threshold_6):
    ...
    final_nochi_file = output_dir + "/final_nochi.fasta"
